...
&emsp; [<i class="bi bi-link-45deg"></i> Tutorials](#tutorials)  
&emsp; [<i class="bi bi-link-45deg"></i> Articles](#articles)  
...
* "[*Type-based Analysis of Road Networks*,]()" **Avionics PhD Talk
  ...
  Sep. 2020. ([**Slides**](uploads/2020/p1_type_and_road.pdf))
...
* "[*LaTeX: An Introduction*,]()" **Conscientia 2019, IIST.**
  ([**Slides**](uploads/2019/p2_LaTeX.pdf),
...
* "[*ARA Wireless Living Lab for Smart and Connected Rural
  Communities*,]()" **Midscale Experimental Research Infrastructure
  Forum (MERIF '23),** Boston, MA, USA, May 2023.
* "[*Introduction to Software Defined Networking*,]()" **AV484
  Wireless Mesh Networks, IIST.**
  ([**Slides**](uploads/2016/p2_Software_Defined_Networks.pdf))
